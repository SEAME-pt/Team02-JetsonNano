                              ...
                              SynchronizedProcessor* processor)
{
    ...
    cv::setWindowProperty("Trajectory", cv::WND_PROP_FULLSCREEN,
...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        LaneDetector laneDetector(
            "/home/team02/Models/engine/lane_Yolo2_epoch_45.engine");
        ObjectDetector objDetector(
            "/home/team02/Models/engine/obj_MOB_1_epoch_133.engine");
