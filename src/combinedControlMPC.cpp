...
int main(int argc, char** argv)
{
    try
    {
        ...
        if (argc == 3)
        {
            ...
            MPController    = new ModelPredictiveController(argv[2], manualController);
        }
        else
        {
        ...
        Eigen::Matrix4d Q = Eigen::Matrix4d::Identity(); //trajectory error costs
        Eigen::Matrix2d R = Eigen::Matrix2d::Identity(); //changes in control costs
        Eigen::Matrix4d Qf = Q;
