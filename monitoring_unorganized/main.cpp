...
/*
this should be running with the zenoh router running (with the proper config
file) - monitor_config.yml and the zenoh-router should be running with the
updated config file - zenoh.json5 we should look in tegrastats results in the
